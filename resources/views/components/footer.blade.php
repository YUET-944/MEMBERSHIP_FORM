<footer class="bg-gradient-to-r from-gray-900 to-gray-800 border-t border-gray-700 text-[10px] py-0.5">
    <div class="container mx-auto px-2">
        <div class="flex items-center justify-between">
            <!-- Copyright -->
            <div class="text-gray-400 whitespace-nowrap overflow-hidden text-ellipsis pr-1">
                &copy; {{ date('Y') }} {{ config('app.name', 'My Portfolio') }}
            </div>
            ...
            <div class="flex items-center space-x-1">
                <!-- Admin -->
                <a href="{{ route('login') }}" 
                   class="text-gray-400 hover:text-white p-0.5 hover:bg-gray-700/50 rounded" 
                   title="Admin Panel">
